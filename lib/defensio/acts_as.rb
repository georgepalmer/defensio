module Defensio
  ...
  module ActsAs
    ...
    module InstanceMethods
      ...
      private
        def check_key
          unless self.class.defensio_options.has_key?(:validate_key) && !self.class.defensio_options[:validate_key]
            raise Defensio::InvalidAPIKey unless self.class.defensio.validate_key.success?
          end
        end
